        ...
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            ...
            <div class="account-wall">
                <img class="profile-img" src="/assets/img/nopicture.png"
                    alt="">
                <form class="form-signin" method="POST" action="/Instrutor/Login">
				{{ csrf_field() }}
            ...
            <a href="/Instrutor/Registrar" class="text-center new-account" style="text-decoration:none;">Seja um Professor</a>
        </div>
    </div>
</div>
<br><br>
