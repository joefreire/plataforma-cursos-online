...
(function ($) {
    ...
    $.extend($.fn.editableform.Constructor.prototype, {
        ...
        initInput: function() {  
            ...
            var defaultClass = 'input-sm '+this.options.name;
            $(this.input.$input).attr('name', this.options.name);
    ...
    $.fn.editableform.buttons = 
      '<button type="button" class="btn btn-primary btn-sm editable-submit" onclick="ENVIA()">'+
        'Salvar'+
      '</button>'+
